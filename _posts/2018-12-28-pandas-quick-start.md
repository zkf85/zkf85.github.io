...
#### 3.1.2. Create a `DataFrame` by passing a NumPy array, with a datetime index and labeled columns:
```python
...
#### 3.1.3. Creating a `DataFrame` by passing a dict of objects that can be converted to series-like.
```python
...
### 3.2. Viewing Data
#### 3.2.1. View the top and bottom rows of the frame:
```python
In [14]: df.head()
Out[14]:
                   A         B         C         D
...
#### 3.2.2. Display the index, columns, and the underlying NumPy data:
```python
In [16]: df.index
Out[16]:
DatetimeIndex(['2013-01-01', '2013-01-02', '2013-01-03', '2013-01-04',
...
#### 3.2.2. `describe()` shows a quick statistic summary of your data:
```python
In [19]: df.describe()
Out[19]:
              A         B         C         D
...
```
![](/public/img/20181228-series_plot_basic.png)
...
```
![](/public/img/20181228-frame_plot_basic.png)

### 3.10. Getting Data In/Out
#### 3.10.1. CSV
